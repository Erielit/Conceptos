...
public class Examen {
    ...
    public static void imprimirPosiciones() {
        int pos = 1;
        System.out.println("Selecciona una posición en el gato: ");
        System.out.println("Las casillas que esten con una X u O ya están ocupadas");
    ...
    public static void registrarJugada(char caracter) throws IOException {
        ...
        do {
            imprimirPosiciones();
            System.out.println("Escriba el número de el lugar  en donde desea tirar: ");
